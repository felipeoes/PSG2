...
def get_files_in_folder(service,  folder_id: str = None,
                        folder_name: str = None,
                        parent_folder_id: str = None, **kwargs):
    """Read all files content in a folder and return a list of files
    ...
    files = list_folders_or_files(service, folder_id, **kwargs)
    return files
...
def read_folder_files_content(
    ...
    try:
        ...
        last_file_name = qa_helper.last_file_name
        last_file_index = qa_helper.last_file_index
...
def upload_file_thread_safe(
    file_path: str, parent_folder_id: str, mimetype: str = "text/plain"
):
    file_metadata = {"name": os.path.basename(
        file_path), "parents": [parent_folder_id]}
